...
TEXT ·csubrdc512(SB),NOSPLIT,$0-16
	...
	XOR  AX,  AX; CMOVQNE ·p+ 0(SB),  AX
	XOR  SI,  SI; CMOVQNE ·p+ 8(SB),  SI
	XOR  DX,  DX; CMOVQNE ·p+16(SB),  DX
	XOR  CX,  CX; CMOVQNE ·p+24(SB),  CX
	XOR  R8,  R8; CMOVQNE ·p+32(SB),  R8
	XOR  R9,  R9; CMOVQNE ·p+40(SB),  R9
	XOR R10, R10; CMOVQNE ·p+48(SB), R10
	XOR R11, R11; CMOVQNE ·p+56(SB), R11

	MOVQ ( 0)(DI), R12; ADDQ  AX, R12; MOVQ R12, ( 0)(DI)
	MOVQ ( 8)(DI), R12; ADCQ  SI, R12; MOVQ R12, ( 8)(DI)
	MOVQ (16)(DI), R12; ADCQ  DX, R12; MOVQ R12, (16)(DI)
	MOVQ (24)(DI), R12; ADCQ  CX, R12; MOVQ R12, (24)(DI)
	MOVQ (32)(DI), R12; ADCQ  R8, R12; MOVQ R12, (32)(DI)
	MOVQ (40)(DI), R12; ADCQ  R9, R12; MOVQ R12, (40)(DI)
	MOVQ (48)(DI), R12; ADCQ R10, R12; MOVQ R12, (48)(DI)
	MOVQ (56)(DI), R12; ADCQ R11, R12; MOVQ R12, (56)(DI)
