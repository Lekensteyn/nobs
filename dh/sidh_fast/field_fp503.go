...
func CondSwap(xPx, xPz, xQx, xQz *Fp2Element, choice uint8) {
...
func ToMontgomery(x *Fp2Element) {
	var aRR FpElementX2
...
func FromMontgomery(x *Fp2Element, out *Fp2Element) {
	var aR FpElementX2
